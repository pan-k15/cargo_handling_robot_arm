...
def generate_launch_description():
    ...
    cargo_world = PathJoinSubstitution([
        FindPackageShare('robot_simulation'), 'worlds', 'cargo_world.sdf'
    ])
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments=[('gz_args', ['-r -v 1 ', cargo_world])],
        ),
        ...
        # Service servers start after controllers are ready
        RegisterEventHandler(
            OnProcessExit(
                target_action=arm_controller_spawner,
                on_exit=[pick_server, place_server],
            )
        ),
    ])
