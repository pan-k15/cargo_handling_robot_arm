...
def generate_launch_description():
    ...
    object_world_v2 = PathJoinSubstitution([
        FindPackageShare('robot_simulation'), 'worlds', 'object_v2.sdf'
    ])
    ...
    # ── Vision: two-block orchestrator ───────────────────────────────
    sort_orchestrator_v2 = Node(
        package='robot_vision',
        executable='sort_orchestrator_v2.py',
        name='pick_orchestrator_v2',
        output='screen',
        parameters=[{'use_sim_time': use_sim_time}],
    )
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments=[('gz_args', ['-r -v 1 ', object_world_v2])],
        ),
