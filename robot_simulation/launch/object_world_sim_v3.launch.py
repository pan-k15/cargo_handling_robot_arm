...
def generate_launch_description():
    ...
    object_world_v3 = PathJoinSubstitution([
        FindPackageShare('robot_simulation'), 'worlds', 'object_v3.sdf'
    ])
    ...
    # ── Vision: colour-sort orchestrator ─────────────────────────────
    sort_orchestrator_v3 = Node(
        package='robot_vision',
        executable='sort_orchestrator_v3.py',
        name='sort_orchestrator_v3',
        output='screen',
        parameters=[{'use_sim_time': use_sim_time}],
    )
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments=[('gz_args', ['-r -v 1 ', object_world_v3])],
        ),
